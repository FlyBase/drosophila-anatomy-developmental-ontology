...
.PHONY: travis_checks
travis_checks: odkversion reason_test sparql_test $(REPORTDIR)/obo_qc_fbbt.obo.txt $(REPORTDIR)/chado_load_check_simple.txt $(REPORTDIR)/validate_profile_owl2dl_$(ONT).owl.txt
