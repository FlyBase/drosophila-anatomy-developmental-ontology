...
EXPLICIT_MAP = {
    ...
    'PB(L2)': ('FBbt:00003670', 'protocerebral bridge glomerulus 2'),
    'PB(R2)': ('FBbt:00003670', 'protocerebral bridge glomerulus 2'),
    'PB(L3)': ('FBbt:00003671', 'protocerebral bridge glomerulus 3'),
    'PB(R3)': ('FBbt:00003671', 'protocerebral bridge glomerulus 3'),
    'PB(L4)': ('FBbt:00003672', 'protocerebral bridge glomerulus 4'),
    'PB(R4)': ('FBbt:00003672', 'protocerebral bridge glomerulus 4'),
    'PB(L5)': ('FBbt:00003673', 'protocerebral bridge glomerulus 5'),
    'PB(R5)': ('FBbt:00003673', 'protocerebral bridge glomerulus 5'),
    'PB(L6)': ('FBbt:00003674', 'protocerebral bridge glomerulus 6'),
    'PB(R6)': ('FBbt:00003674', 'protocerebral bridge glomerulus 6'),
    'PB(L7)': ('FBbt:00003675', 'protocerebral bridge glomerulus 7'),
    'PB(R7)': ('FBbt:00003675', 'protocerebral bridge glomerulus 7'),
    'PB(L8)': ('FBbt:00003676', 'protocerebral bridge glomerulus 8'),
    'PB(R8)': ('FBbt:00003676', 'protocerebral bridge glomerulus 8'),
    'PB(L9)': ('FBbt:00003677', 'protocerebral bridge glomerulus 9'),
    'PB(R9)': ('FBbt:00003677', 'protocerebral bridge glomerulus 9'),
