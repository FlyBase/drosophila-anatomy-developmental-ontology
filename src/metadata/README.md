 ...
 * [fbbt.yml](fbbt.yml)
     * Determines how your purl.obolibrary.org/obo/fbbt/ redirects will be handled
     ...
     * Paste in the contents of [fbbt.yml](fbbt.yml)
 ...
 * [fbbt.md](fbbt.md)
     ...
     * Paste in the contents of [fbbt.md](fbbt.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
