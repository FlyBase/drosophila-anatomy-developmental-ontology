...
ontology-release-runner --reasoner elk $JENKINS_HOME/workspace/FBdv_GH/fbdv/src/trunk/ontologies/fbdv-edit.obo go-simple.obo --no-subsets --allow-overwrite --allow-equivalent-pairs --outdir fbdv/src/trunk/oort  
