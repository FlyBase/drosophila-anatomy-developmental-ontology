...
ontology-release-runner --reasoner elk $JENKINS_HOME/workspace/FBbt_GH/fbbt/src/trunk/ontologies/fbbt-edit.obo go-simple.obo --no-subsets --allow-overwrite --outdir fbbt/src/trunk/oort  
