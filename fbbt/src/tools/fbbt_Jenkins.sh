...
echo ''
owltools tmp.obo --merge fbbt/src/ontologies/fbbt_auth_attrib_licence.owl -o file://`pwd`/tmp0.owl
owltools tmp0.owl --merge fbbt/src/ontologies/fbbt-ext.owl -o file://`pwd`/tmp.owl
