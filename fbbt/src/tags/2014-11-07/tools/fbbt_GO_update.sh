...
ontology-release-runner --reasoner elk $JENKINS_HOME/workspace/FBbt_SF_trunk/ontologies/fbbt-edit.obo go-simple.obo --no-subsets --allow-overwrite --outdir oort  
