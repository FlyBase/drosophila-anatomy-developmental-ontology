...
ontology-release-runner --reasoner elk $JENKINS_HOME/workspace/FBbt_GH_Marta/fbbt/src/trunk/ontologies/fbbt-edit.obo go-simple.obo --no-subsets --allow-overwrite --outdir oort  
