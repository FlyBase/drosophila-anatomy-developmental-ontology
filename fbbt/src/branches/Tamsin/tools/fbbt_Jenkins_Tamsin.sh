...
echo ''
chado_load_checks.pl fbbt/src/branches/Tamsin/ontologies/fbbt-edit.obo > fbbt-edit_checks.txt
echo ''
echo '*** Generating potential release ***'
echo '** Rolling autodefs **'
update_EC_defs.pl fbbt/src/branches/Tamsin/ontologies/fbbt-edit.obo > tmp.obo
echo ''
